...
#define P_FLAG_FORCE_SHINY      0x863     // If this flag is set, all wild and gift Pokémon will forced into being Shiny.
#define P_FLAG_FORCE_NO_SHINY   0x88E     // If this flag is set, all wild and gift Pokémon will forced into NOT being Shiny.
