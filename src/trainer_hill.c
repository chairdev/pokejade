...
} static const sTrainerClassesAndMusic[] =
{
    ...
    {TRAINER_CLASS_TEAM_ETERNITY, TRAINER_ENCOUNTER_MUSIC_MAGMA},
...
static const u16 sPrizeListRoar[]        = {ITEM_TM_ICY_WIND,          ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
