...
static const u8 *const sMalePresetNames[] = {
    COMPOUND_STRING("Caden")
};

static const u8 *const sFemalePresetNames[] = {
    COMPOUND_STRING("Holly")
};
...
static void Task_NewGameBirchSpeechSub_InitPokeBall(u8 taskId)
{
    ...
    CreatePokeballSpriteToReleaseMon(spriteId, gSprites[spriteId].oam.paletteNum, 112, 58, 0, 0, 32, PALETTES_BG, SPECIES_GLIMMET);
...
{
    return CreateMonPicSprite_Affine(SPECIES_GLIMMET, FALSE, 0, MON_PIC_AFFINE_FRONT, x, y, 14, TAG_NONE);
}
