...
static const u8 sText_PkmnCaughtInMudSnare[] = _("{B_DEF_NAME_WITH_PREFIX} was\ncaught in the mud!\p");
...
static const u8 sText_DontLeaveBirch[] = _("It's no use! You can't run away!\p");
...
static const u8 sText_OpponentMon1Appeared[] = _("You encountered a {B_OPPONENT_MON1_NAME}!\p");
...
static const u8 sText_TwoWildPkmnAppeared[] = _("You encountered a wild {B_OPPONENT_MON1_NAME} and\n{B_OPPONENT_MON2_NAME}!\p");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_PKMNCAUGHTINMUDSNARE - BATTLESTRINGS_TABLE_START] = sText_PkmnCaughtInMudSnare,
...
const u16 gWrappedStringIds[NUM_TRAPPING_MOVES] =
{
    ...
    [B_MSG_WRAPPED_MUD_SNARE]   = STRINGID_PKMNCAUGHTINMUDSNARE,  // MOVE_MUD_SNARE
};
...
static const u8 sText_PlayerLostAgainstTrainer1[] = _("You lost against\n{B_TRAINER1_CLASS} {B_TRAINER1_NAME}!");
