static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_ARGIL_TOWN - 1] = {MAP_GROUP(ARGIL_TOWN), MAP_NUM(ARGIL_TOWN), 7, 13},
    [HEAL_LOCATION_BAYCREST_CITY - 1] = {MAP_GROUP(BAYCREST_CITY), MAP_NUM(BAYCREST_CITY), 14, 34},
    [HEAL_LOCATION_STEMFORD_TOWN - 1] = {MAP_GROUP(STEMFORD_TOWN), MAP_NUM(STEMFORD_TOWN), 17, 12},
    [HEAL_LOCATION_STARRIDGE_CITY - 1] = {MAP_GROUP(STARRIDGE_CITY), MAP_NUM(STARRIDGE_CITY), 11, 20},
    [HEAL_LOCATION_DOLOMITE_CITY - 1] = {MAP_GROUP(DOLOMITE_CITY), MAP_NUM(DOLOMITE_CITY), 11, 25},
    [HEAL_LOCATION_ZIRCON_TOWN - 1] = {MAP_GROUP(ZIRCON_TOWN), MAP_NUM(ZIRCON_TOWN), 12, 17},
    [HEAL_LOCATION_SPINEL_CITY - 1] = {MAP_GROUP(SPINEL_CITY), MAP_NUM(SPINEL_CITY), 35, 21},
};
