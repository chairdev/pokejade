...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping_BW[] =
{
    ...
    [MAPSEC_EVERWOOD_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_501] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_BAYCREST_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_502] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_FORTUNE_CAVE] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_503] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_KISMET_FOREST] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_STEMFORD_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_504] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_STARRIDGE_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_ROUTE_305] = MAPPOPUP_THEME_BW_DEFAULT,
