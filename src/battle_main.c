...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_TEAM_AQUA] = { _("Team Eternity") },
    [TRAINER_CLASS_PKMN_BREEDER] = { _("Pokémon Breeder"), 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? ITEM_HEAL_BALL : ITEM_FRIEND_BALL },
    [TRAINER_CLASS_COOLTRAINER] = { _("Ace Trainer"), 12, ITEM_ULTRA_BALL },
    ...
    [TRAINER_CLASS_AQUA_ADMIN] = { _("Team Eternity Admin"), 10 },
    ...
    [TRAINER_CLASS_COOLTRAINER_2] = { _("Cooltrainer"), 5, ITEM_ULTRA_BALL },
